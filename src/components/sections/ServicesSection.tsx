...
const services = [
    ...
    },
    {
        ...
        glowColor: "#FB923C18",
        features: [
            "Elimina tareas repetitivas: el flujo trabaja 24/7 sin errores",
            "Conecta WhatsApp, CRM, email, facturación y más en minutos",
            "Notificaciones automáticas cuando ocurre algo importante",
            "Sin código complejo — n8n es visual, flexible y poderoso",
            "ROI en semanas: ahorra horas de trabajo manual cada mes",
        ],
        cta: "Automatiza mi negocio",
        href: "#contacto",
    },
];
